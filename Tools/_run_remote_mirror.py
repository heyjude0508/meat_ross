import sys, time
sys.path.insert(0, r"E:\game\design\Epic Games\UE_5.7\Engine\Plugins\Experimental\PythonScriptPlugin\Content\Python")
...
cmd = r'E:/game/design/Epic Games/project/meat_ross/Tools/MirrorCubicle93.py'
